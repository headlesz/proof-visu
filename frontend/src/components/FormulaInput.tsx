    ...
    >
      <Box
        sx={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(120deg, rgba(255,255,255,0.06), rgba(220,214,255,0.035))',
          pointerEvents: 'none',
        }}
      />
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2, mb: 1.1, flexWrap: 'wrap' }}>
          <Box
            sx={{
              ...
              display: 'grid',
              placeItems: 'center',
              bgcolor: 'rgba(220,214,255,0.14)',
              border: '1px solid rgba(220,214,255,0.42)',
            }}
          >
            ...
            sx={{
              ...
              '& .MuiToggleButton-root': {
                ...
                '&.Mui-selected': {
                  ...
                  borderColor: 'rgba(220,214,255,0.8)',
                },
              },
            }}
          >
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                ...
                boxShadow: '0 14px 26px rgba(220,214,255,0.16)',
              },
            }}
          >
              ...
              <Chip
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    color: 'primary.main',
                    borderColor: 'rgba(220,214,255,0.6)',
                    bgcolor: 'rgba(220,214,255,0.12)',
                  },
                }}
                variant="outlined"
              />
